(function () {
  ...
  function renderTraining() {
    ...
    html += `<div class="training-run-card">
      <div class="training-run-copy">
    ...
    html += `<details class="add-extra-panel">
      <summary class="add-s-btn add-extra-summary">${t('compactAddExercise')}</summary>
      <div class="add-extra-box add-extra-box-bottom">
  ...
  function renderFinishBar() {
    ...
    if (finished[day]) {
      ...
      $('finish-start-new')?.addEventListener('click', () => startTrainingRun(true));
      return;
    }
    if (finishConfirm) {
